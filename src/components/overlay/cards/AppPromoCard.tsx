  ...
  return (
    <OverlayCard preset="slide-right" className="group">
      <a
        ...
        className="flex items-center gap-3 rounded-xl bg-black/50 backdrop-blur-2xl border border-white/[0.08] px-3 py-2.5 shadow-2xl shadow-black/40 transition-all duration-300 hover:bg-black/60 hover:border-white/[0.12] hover:translate-y-[-1px] w-[300px]"
        style={{
          borderLeftWidth: 2,
          borderLeftColor: promo.accent,
          boxShadow: `0 0 20px ${promo.accent}10, 0 8px 32px rgba(0,0,0,0.4)`,
        }}
      >
        {/* App thumbnail */}
        <div
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] font-light text-white/50 leading-snug line-clamp-2 mt-0.5">
            {promo.tagline}
          </p>
        </div>
